...
const InputImage = ({ image, setImage }: Props) => {
    ...
    return (
        <div className={"flex items-center justify-center w-40 h-40 mt-4"}>
            {
                image ? (
                    ...
                    <label className={"relative flex flex-col items-center justify-center w-full h-full border-4 border-dashed hover:bg-gray-100 hover:border-gray-300"}>
