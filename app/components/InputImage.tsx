        ...
        <div className={"flex items-center justify-center w-40 h-40"}>
            {
                image ? (
                    ...
                    <label className={"relative flex flex-col items-center justify-center w-full h-full border-2 border-dashed hover:bg-slate-800 hover:border-gray-300 rounded-md"}>
